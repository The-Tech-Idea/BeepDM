...
description: Entry-point guidance for SharedContextAssemblyHandler and the PluginSystem integration in BeepDM. Use when loading assemblies in shared-context mode, scanning components, handling NuGet package operations, or coordinating plugin lifecycle managers. Cross-references driver implementation and Setup Framework integration.
---
...
- Support [AddinAttribute] discovery for custom IDataSource drivers.
...
- [`drivers-nuget-idatasource-implementation`](../drivers-nuget-idatasource-implementation/SKILL.md) — Custom driver development & NuGet packaging
- [`setup`](../setup/SKILL.md) — Integration with Setup Framework (DriverProvisionStep)
