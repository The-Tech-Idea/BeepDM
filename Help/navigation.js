...
class NavigationManager {
    ...
    createNavigationMapping() {
        return {
            ...
            'examples-editor-classes': {
                activeId: 'nav-examples-editor-classes',
                openSection: 'nav-data-management'
            },
            'examples-runtime-surfaces': {
                activeId: 'nav-examples-runtime-surfaces',
                openSection: 'nav-data-management'
            },
            'best-practices': {
            ...
            'dataviewdatasource': {
                activeId: 'nav-dataviewdatasource',
                openSection: 'nav-data-management'
            },
            'caching-api': {
                activeId: 'nav-caching-api',
                openSection: 'nav-data-management'
            },
            'proxy-datasource': {
            ...
            'etl-engine-pipeline': {
                activeId: 'nav-etl-engine-pipeline',
                openSection: 'nav-advanced-topics'
            },
            'etl-engine-scheduling': {
                activeId: 'nav-etl-engine-scheduling',
                openSection: 'nav-advanced-topics'
            },
            'etl-engine-observability': {
                activeId: 'nav-etl-engine-observability',
                openSection: 'nav-advanced-topics'
            },
            ...
            'services-registration-lifetimes': {
                activeId: 'nav-services-registration-lifetimes',
                openSection: 'nav-advanced-topics'
            },
