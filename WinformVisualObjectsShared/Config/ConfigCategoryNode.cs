...
{
    public class ConfigCategoryNode  : IBranch, ITreeView
    {
        public ConfigCategoryNode()
        {

        }
        public ConfigCategoryNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumBranchType pBranchType, string pimagename)
        {
