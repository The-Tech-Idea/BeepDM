...
namespace AI
{
    public class AICategoryNode : IBranch, ITreeView, IOrder
    {
        ...
        public AICategoryNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumBranchType pBranchType, string pimagename)
        {
        ...
        public IErrorsInfo CreateCategoryNode(IBranch Rootbr, CategoryFolder p)
        {
            try
            {
                AICategoryNode Category = new AICategoryNode(TreeEditor, DMEEditor, Rootbr, p.FolderName, TreeEditor.SeqID, EnumBranchType.Category, TreeEditor.CategoryIcon);
