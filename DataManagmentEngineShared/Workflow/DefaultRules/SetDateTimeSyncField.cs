...
{
    [Addin(Caption = "Set DateTime Sync Field", Name = "SetDateTimeSyncField", misc = "Defaults", addinType = AddinType.Class, returndataTypename = "string")]
    public class SetDateTimeSyncField : IWorkFlowRule
    {
        public SetDateTimeSyncField(IDMEEditor pDMEEditor)
        {
