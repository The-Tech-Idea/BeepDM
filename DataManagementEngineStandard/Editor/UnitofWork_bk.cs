...
#endif
    public partial class UnitofWork_bk<T> : IUnitofWork<T>, INotifyPropertyChanged where T : Entity, new()
    {
        ...
        public UnitofWork_bk() : base()
        {
            // Initialization logic specific for design-time
            // This can be empty or can set default values
        }
        public UnitofWork_bk(IDMEEditor dMEEditor, string datasourceName, string entityName)
        {
            IsInListMode = false;
        ...
        public UnitofWork_bk(IDMEEditor dMEEditor, string datasourceName, string entityName, EntityStructure entityStructure)
        {
            IsInListMode = false;
            _suppressNotification = true;
            DMEEditor = dMEEditor;
        ...
        public UnitofWork_bk(IDMEEditor dMEEditor, bool isInListMode, ObservableBindingList<T> ts)
        {
            _suppressNotification = true;
            DMEEditor = dMEEditor;
        ...
        public UnitofWork_bk(IDMEEditor dMEEditor, string datasourceName, string entityName, string primarykey)
        {
            IsInListMode = false;
            _suppressNotification = true;
            DMEEditor = dMEEditor;
        ...
        public UnitofWork_bk(IDMEEditor dMEEditor, string datasourceName, string entityName, EntityStructure entityStructure, string primarykey)
        {
            IsInListMode = false;
            _suppressNotification = true;
            DMEEditor = dMEEditor;
        ...
        public UnitofWork_bk(IDMEEditor dMEEditor, bool isInListMode, ObservableBindingList<T> ts, string primarykey)
        {
            _suppressNotification = true;
            DMEEditor = dMEEditor;
            IsInListMode = isInListMode;
