...
// Staging, DataImportConfiguration, IDataQualityRule, IImportErrorStore,
// IImportRunHistoryStore moved to models: TheTechIdea.Beep.Editor.Importing (ImportModels.cs)
...
namespace TheTechIdea.Beep.Editor.Importing.Interfaces
{
    ...
    // -------------------------------------------------------------------------
    // Phase 1 — Shared context model (moved to DataManagementModelsStandard/Editor/Importing/ImportModels.cs)
    // All POCOs, enums, and shared interfaces now live in TheTechIdea.Beep.Editor.Importing namespace
    // in the models project so IConfigEditor and other projects can reference them.
    // -------------------------------------------------------------------------
}