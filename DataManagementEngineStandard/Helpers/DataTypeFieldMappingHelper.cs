...
namespace TheTechIdea.Beep.Helpers
{
    ...
    public static class DataTypeFieldMappingHelper
    {
        ...
        public static List<DatatypeMapping> GetMappings()
        {
            ...
            ls.AddRange(GetPineConeDataTypesMapping());
            ls.AddRange(GetQdrantDataTypesMapping());
            ls.AddRange(GetShapVectorDataTypesMapping());
            ls.AddRange(GetWeaviateDataTypesMapping());
            ls.AddRange(GetMilvusDataTypesMapping());
            ls.AddRange(GetRedisVectorDataTypesMapping());
            ls.AddRange(GetZillizDataTypesMapping());
            ls.AddRange(GetVespaDataTypesMapping());
            ls.AddRange(GetChromaDBDataTypesMapping());
