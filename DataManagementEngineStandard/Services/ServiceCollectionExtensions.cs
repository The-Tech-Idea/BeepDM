...
namespace TheTechIdea.Beep.Services
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        // Add other service registration methods as needed like IDMEditor
        public static IServiceCollection AddDMEEditor(this IServiceCollection services,IAssemblyHandler assemblyHandler, IDMLogger logger)
        {
            services.TryAddSingleton<DMEEditor>();
            services.TryAddSingleton<IDMEEditor>(provider => provider.GetRequiredService<DMEEditor>());
            return services;
        }
    }
}